...
public class SWE4403_ConfirmationDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public SWE4403_ConfirmationDialog(JFrame ownerFrame, JDialog ownerDialog, String title, String type) {
		super();
