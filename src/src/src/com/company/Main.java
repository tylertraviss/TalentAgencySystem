...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		Musician JohnLennon = new Musician("John Lennon", 82, "Male", "United Kingdom", null, null, .20, null,
				"John Lennon", "Rock", null, 500000);

		// Adding Athlete

		Athlete LeoMessi = new Athlete("Leo Messi", 32, "Male", "Argentina", null, null, .30, null, 156, 60, "Soccer",
				5000000);

		// Adding Actor

		Actor TomHolland = new Actor("Tom Holland", 25, "Male", "United Kingdom", null, null, 0.4, null, "Movie Actor",
				2500000);
