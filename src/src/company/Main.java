...
// 		Employee Barrera = new Employee("Julian Barerra", 35, "Male", "Canada", "Chief Executive Officer", 100000,
// 				startTime, finishTime, null);

// 		Employee Elliot = new Employee("Elliot Chin", 20, "Male", "Canada", "Chief Software Developer", 90000,
// 				startTime, finishTime, Barrera);

// 		Employee Kisenge = new Employee("Kisenge Mbaga", 20, "Male", "Canada", "Chief Operations Officer", 90000,
// 				startTime, finishTime, Barrera);

// 		Employee Tyler = new Employee("Tyler Travis", 20, "Male", "Canada", "Chief Machine Learning Officer", 90000,
// 				startTime, finishTime, Barrera);

// 		Employee Carter = new Employee("Carter Moore", 19, "Male", "Canada", "Computer Programming Intern", 35000,
// 				startTime, finishTime, Barrera);

// 		Employee EthanGarnier = new Employee("Ethan Garnier", 21, "Male", "Canada", "Chief Cloud Tech Officer", 90000,
// 				startTime, finishTime, Barrera);

// 		// Adding Musician

// 		// Musician JohnLennon = new Musician("John Lennon", 82, "Male", "United
// 		// Kingdom", null, null, .20, null,
// 		// "John Lennon", "Rock", null, 500000);

// 		// // Adding Athlete

// 		// Athlete LeoMessi = new Athlete("Leo Messi", 32, "Male", "Argentina", null,
// 		// null, .30, null, 156, 60, "Soccer",
// 		// 5000000);

// 		// // Adding Actor

// 		// Actor TomHolland = new Actor("Tom Holland", 25, "Male", "United Kingdom",
// 		// null, null, 0.4, null, "Movie Actor",
// 		// 2500000);
...
// 		// SponsoredClient client2 = new SponsoredClient(JohnLennon,
// 		// sponsorshipMediator);
