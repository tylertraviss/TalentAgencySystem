...
public class Company {
	...
	/* a recursive method that gets all the subordinates */
	...
	private void removeSponsorship(Client client) {
		...
		var sponsorship = sponsorshipMediator.getSponsorshipByClient(client);
	 ...
	 * Ultimately, this function will return a list where index 0 is the passed
	 * employee and its subordinates are listed out from index 1.
	 */
